...
async def list_products(
    ...
    for d in docs:
        results.append(ProductResponse(
            ...
            manufactured_for_name=d.get("manufactured_for_name", ""),
            manufactured_for_address=d.get("manufactured_for_address", ""),
            generic_note=d.get("generic_note", ""),
...
async def update_product(prod_id: str, prod_update: ProductUpdate):
    ...
    return ProductResponse(
        ...
        manufactured_for_name=updated_doc.get("manufactured_for_name", ""),
        manufactured_for_address=updated_doc.get("manufactured_for_address", ""),
        generic_note=updated_doc.get("generic_note", ""),
